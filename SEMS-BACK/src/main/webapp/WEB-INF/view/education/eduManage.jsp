		...
		<c:forEach items="${ eduHistoryListVO.educationHistoryList }"
			...
			<c:if test="${ eduHistory.state eq 'EDU_JN_A' }">
				<tr>
					...
					<td>
						<button class="joinaply" data-toggle="modal" data-id="${eduHistory.educationHistoryId}" data-whatever="${eduHistory.memberId }"
		data-target="#JoinAplyModal">교육참여승인</button>
					</td>
					<td>
						<button class="cnclaply" data-toggle="modal" data-id="${eduHistory.educationHistoryId}" data-whatever="${eduHistory.memberId }"
			...
			<td colspan="8" align="center">
				<form name="searchForm" id="searchForm">
					...
					<div style="text-align: right;">
						...
						<input type="button" id="searchBtn" value="검색" class="inputButton" />
						<input type="button" id="searchInitBtn" value="검색 초기화" class="inputButton" />
					</div>
				</form>
			</td>
		</tr>	
		...
		<div class="modal-dialog modal-sm">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="joinAplyBtn" style="display : inline;">
					정말	승인</button>
					<button type="button" data-dismiss="modal"  style="display : inline;">
						취소</button>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog modal-sm">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="joinCnclBtn" style="display : inline;">
					정말	거절</button>
					<button type="button" data-dismiss="modal" style="display : inline;">
						취소</button>
				</div>
