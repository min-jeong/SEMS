...
<div>
	<span style="text-align: center;"><h3>현재 수강 목록</h3></span>
		<table style="text-align: center;">
			<tr>
				<th width="40%">교육 명</th>
				<th width="30%">교육 시작일</th>
				<th width="30%">교육 종료일</th>
			</tr>
			<c:forEach items="${educationListVO}" var="educationVO">
				<tr>
					<td><input type="hidden" id="${ educationVO.educationId }" value="${ educationVO.educationId }"/><span class="educationId" style="cursor:pointer;">${educationVO.educationTitle}</span></td>
					<td>${ educationVO.startDate }</td>
					<td>${ educationVO.endDate }
					<a href="<c:url value='/resignCourse/${educationVO.educationId}'/>" target="_blank" 
...
<br/>
<div>
	<span style="text-align: center;"><h3>이전 수강 목록</h3></span>
		<table style="text-align: center;">
			<tr>
				<th width="40%">교육 명</th>
				<th width="30%">교육 시작일</th>
